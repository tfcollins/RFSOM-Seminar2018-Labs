...
add_files -norecurse {../hdl/vhdl/CombinedT_ip_src_DotProduct.vhd}
...
add_files -norecurse {../hdl/vhdl/CombinedT_ip_src_DotProduct_block.vhd}
...
add_files -norecurse {../hdl/vhdl/CombinedT_ip_src_Configuration_Variables.vhd}
add_files -norecurse {../hdl/vhdl/CombinedT_ip_src_IQ_Interface_Mapper.vhd}
add_files -norecurse {../hdl/vhdl/CombinedT_ip_src_DMA_Model_Driver1.vhd}
...
set_property core_revision 1802011149 [ipx::current_core]
...
ipx::add_file {hdl/vhdl/CombinedT_ip_src_DotProduct.vhd} [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/CombinedT_ip_src_DotProduct.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]]
ipx::add_file {hdl/vhdl/CombinedT_ip_src_DotProduct.vhd} [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/CombinedT_ip_src_DotProduct.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]]
...
ipx::add_file {hdl/vhdl/CombinedT_ip_src_DotProduct_block.vhd} [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/CombinedT_ip_src_DotProduct_block.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]]
ipx::add_file {hdl/vhdl/CombinedT_ip_src_DotProduct_block.vhd} [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/CombinedT_ip_src_DotProduct_block.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]]
...
ipx::add_file {hdl/vhdl/CombinedT_ip_src_Configuration_Variables.vhd} [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/CombinedT_ip_src_Configuration_Variables.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]]
ipx::add_file {hdl/vhdl/CombinedT_ip_src_Configuration_Variables.vhd} [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/CombinedT_ip_src_Configuration_Variables.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]]
ipx::add_file {hdl/vhdl/CombinedT_ip_src_IQ_Interface_Mapper.vhd} [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/CombinedT_ip_src_IQ_Interface_Mapper.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]]
ipx::add_file {hdl/vhdl/CombinedT_ip_src_IQ_Interface_Mapper.vhd} [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/CombinedT_ip_src_IQ_Interface_Mapper.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]]
ipx::add_file {hdl/vhdl/CombinedT_ip_src_DMA_Model_Driver1.vhd} [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/CombinedT_ip_src_DMA_Model_Driver1.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagesynthesis -of_objects [ipx::current_core]]]
ipx::add_file {hdl/vhdl/CombinedT_ip_src_DMA_Model_Driver1.vhd} [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]
set_property type {{vhdlSource}} [ipx::get_files {hdl/vhdl/CombinedT_ip_src_DMA_Model_Driver1.vhd} -of_objects [ipx::get_file_groups xilinx_anylanguagebehavioralsimulation -of_objects [ipx::current_core]]]
...
ipx::add_file {doc/combinedTxRx_StandardIQ_ip_core_report.html} [ipx::get_file_groups xilinx_productguide -of_objects [ipx::current_core]]
set_property type {{html}} [ipx::get_files {doc/combinedTxRx_StandardIQ_ip_core_report.html} -of_objects [ipx::get_file_groups xilinx_productguide -of_objects [ipx::current_core]]]
