%--------------------------------------------------------------------------
% HDL Workflow Script
% Generated with MATLAB 9.3 (R2017b) at 11:43:28 on 01/02/2018
% This script was generated using the following parameter values:
%     Filename  : 'C:\Seminar\Lab3\modem-phy\FixedPoint\standard_iq\hdlworkflow.m'
%     Overwrite : true
%     Comments  : true
%     Headers   : true
...
% Set Outport HDL parameters
hdlset_param('combinedTxRx_StandardIQ/Combined TX and RX/Receiver HDL/crcErr', 'IOInterface', 'No Interface Specified');
hdlset_param('combinedTxRx_StandardIQ/Combined TX and RX/Receiver HDL/crcErr', 'IOInterfaceMapping', '');

% Set Outport HDL parameters
hdlset_param('combinedTxRx_StandardIQ/Combined TX and RX/Receiver HDL/validCRC', 'IOInterface', 'No Interface Specified');
hdlset_param('combinedTxRx_StandardIQ/Combined TX and RX/Receiver HDL/validCRC', 'IOInterfaceMapping', '');

% Set Outport HDL parameters
hdlset_param('combinedTxRx_StandardIQ/Combined TX and RX/Receiver HDL/endFlag', 'IOInterface', 'No Interface Specified');
hdlset_param('combinedTxRx_StandardIQ/Combined TX and RX/Receiver HDL/endFlag', 'IOInterfaceMapping', '');
