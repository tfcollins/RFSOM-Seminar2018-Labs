-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\combinedTxRx_AXIMM\CombinedT_ip_dut.vhd
...
BEGIN
  ...
  packetCount <= packetCount_sig;

  selectedError <= selectedError_sig;

  packetLen <= packetLen_sig;
