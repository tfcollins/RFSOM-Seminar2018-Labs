-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\combinedTxRx_AXIMM\CombinedT_ip_src_Equalization_and_Demodulation.vhd
...
-- Source Path: combinedTxRx_AXIMM/Combined TX and RX/Receiver HDL/Frame Recover/Equalization and Demodulation
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF CombinedT_ip_src_Equalization_and_Demodulation IS
  ...
  SIGNAL DFE_out1_re_signed               : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL DFE_out1_im_signed               : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL DFE_out1_bypass_re               : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL DFE_out1_bypass_im               : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL DFE_out1_last_value_re           : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL DFE_out1_last_value_im           : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  DFE_out1_re_signed <= signed(DFE_out1_re);

  DFE_out1_im_signed <= signed(DFE_out1_im);

  AfterEQ_bypass_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      DFE_out1_last_value_re <= to_signed(16#0000#, 16);
      DFE_out1_last_value_im <= to_signed(16#0000#, 16);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        DFE_out1_last_value_re <= DFE_out1_bypass_re;
        DFE_out1_last_value_im <= DFE_out1_bypass_im;
      END IF;
    END IF;
  END PROCESS AfterEQ_bypass_process;


  
  DFE_out1_bypass_re <= DFE_out1_last_value_re WHEN Enable_out4_1 = '0' ELSE
      DFE_out1_re_signed;
  
  DFE_out1_bypass_im <= DFE_out1_last_value_im WHEN Enable_out4_1 = '0' ELSE
      DFE_out1_im_signed;

  AfterEQ_re <= std_logic_vector(DFE_out1_bypass_re);

  AfterEQ_im <= std_logic_vector(DFE_out1_bypass_im);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        delayMatch2_reg(0) <= Skip_EQ_Training_Symbols_After_Barker_out1;
        delayMatch2_reg(1) <= delayMatch2_reg(0);
      END IF;
    END IF;
  END PROCESS delayMatch2_process;

  Skip_EQ_Training_Symbols_After_Barker_out1_1 <= delayMatch2_reg(1);
