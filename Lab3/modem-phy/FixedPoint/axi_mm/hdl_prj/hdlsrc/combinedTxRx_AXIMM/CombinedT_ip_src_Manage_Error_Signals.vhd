-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\combinedTxRx_AXIMM\CombinedT_ip_src_Manage_Error_Signals.vhd
...
-- Source Path: combinedTxRx_AXIMM/Combined TX and RX/Receiver HDL/Frame Recover/Manage Error Signals
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF CombinedT_ip_src_Manage_Error_Signals IS
  ...
  SIGNAL delayMatch_reg                   : vector_of_signed8(0 TO 5);  -- sfix8 [6]
  ...
  SIGNAL delayMatch3_reg                  : vector_of_signed32(0 TO 5);  -- sfix32 [6]
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      delayMatch_reg <= (OTHERS => to_signed(16#00#, 8));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        delayMatch_reg(0) <= ErrorSelector_signed;
        delayMatch_reg(1 TO 5) <= delayMatch_reg(0 TO 4);
      END IF;
    END IF;
  END PROCESS delayMatch_process;

  ErrorSelector_1 <= delayMatch_reg(5);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        delayMatch1_reg(0) <= Data_Type_Conversion1_out1;
        delayMatch1_reg(1 TO 5) <= delayMatch1_reg(0 TO 4);
      END IF;
    END IF;
  END PROCESS delayMatch1_process;

  Data_Type_Conversion1_out1_1 <= delayMatch1_reg(5);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        delayMatch2_reg(0) <= Peak_Detector_Counter_out1;
        delayMatch2_reg(1) <= delayMatch2_reg(0);
      END IF;
    END IF;
  END PROCESS delayMatch2_process;

  Peak_Detector_Counter_out1_1 <= delayMatch2_reg(1);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        delayMatch3_reg(0) <= Data_Type_Conversion_out1;
        delayMatch3_reg(1 TO 5) <= delayMatch3_reg(0 TO 4);
      END IF;
    END IF;
  END PROCESS delayMatch3_process;

  Data_Type_Conversion_out1_1 <= delayMatch3_reg(5);
