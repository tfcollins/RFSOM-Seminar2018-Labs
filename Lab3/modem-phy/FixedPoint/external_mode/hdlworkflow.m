%--------------------------------------------------------------------------
% HDL Workflow Script
% Generated with MATLAB 9.3 (R2017b) at 13:15:39 on 01/02/2018
% This script was generated using the following parameter values:
%     Filename  : 'C:\Seminar\Lab3\modem-phy\FixedPoint\external_mode\hdlworkflow.m'
%     Overwrite : true
%     Comments  : true
%     Headers   : true
...
hdlset_param('combinedTxRx_ExternalMode/Combined TX and RX/ValidInTx', 'IOInterface', 'Tx data Valid In');
hdlset_param('combinedTxRx_ExternalMode/Combined TX and RX/ValidInTx', 'IOInterfaceMapping', '[0]');

% Set Inport HDL parameters
hdlset_param('combinedTxRx_ExternalMode/Combined TX and RX/rInTx', 'IOInterface', 'Tx data I1 In [0:15]');
hdlset_param('combinedTxRx_ExternalMode/Combined TX and RX/rInTx', 'IOInterfaceMapping', '[0:15]');

% Set Inport HDL parameters
hdlset_param('combinedTxRx_ExternalMode/Combined TX and RX/iInTx', 'IOInterface', 'Tx data Q1 In [0:15]');
hdlset_param('combinedTxRx_ExternalMode/Combined TX and RX/iInTx', 'IOInterfaceMapping', '[0:15]');
...
% Set Inport HDL parameters
hdlset_param('combinedTxRx_ExternalMode/Combined TX and RX/FromRadioValidIn', 'IOInterface', 'Rx data Valid In');
hdlset_param('combinedTxRx_ExternalMode/Combined TX and RX/FromRadioValidIn', 'IOInterfaceMapping', '[0]');

% Set Inport HDL parameters
hdlset_param('combinedTxRx_ExternalMode/Combined TX and RX/LoopBW', 'IOInterface', 'AXI4-Lite');
hdlset_param('combinedTxRx_ExternalMode/Combined TX and RX/LoopBW', 'IOInterfaceMapping', 'x"100"');
...
% Set Inport HDL parameters
hdlset_param('combinedTxRx_ExternalMode/Combined TX and RX/SelectScope', 'IOInterface', 'AXI4-Lite');
hdlset_param('combinedTxRx_ExternalMode/Combined TX and RX/SelectScope', 'IOInterfaceMapping', 'x"108"');

% Set Inport HDL parameters
hdlset_param('combinedTxRx_ExternalMode/Combined TX and RX/ErrorSelect', 'IOInterface', 'No Interface Specified');
hdlset_param('combinedTxRx_ExternalMode/Combined TX and RX/ErrorSelect', 'IOInterfaceMapping', '');
...
% Set Outport HDL parameters
hdlset_param('combinedTxRx_ExternalMode/Combined TX and RX/Receiver HDL/crcErr', 'IOInterface', 'No Interface Specified');
hdlset_param('combinedTxRx_ExternalMode/Combined TX and RX/Receiver HDL/crcErr', 'IOInterfaceMapping', '');

% Set Outport HDL parameters
hdlset_param('combinedTxRx_ExternalMode/Combined TX and RX/Receiver HDL/validCRC', 'IOInterface', 'No Interface Specified');
hdlset_param('combinedTxRx_ExternalMode/Combined TX and RX/Receiver HDL/validCRC', 'IOInterfaceMapping', '');

% Set Outport HDL parameters
hdlset_param('combinedTxRx_ExternalMode/Combined TX and RX/Receiver HDL/endFlag', 'IOInterface', 'No Interface Specified');
hdlset_param('combinedTxRx_ExternalMode/Combined TX and RX/Receiver HDL/endFlag', 'IOInterfaceMapping', '');
...
% Set Outport HDL parameters
hdlset_param('combinedTxRx_ExternalMode/Combined TX and RX/FromIPR', 'IOInterface', 'Rx data I1 Out [0:15]');
hdlset_param('combinedTxRx_ExternalMode/Combined TX and RX/FromIPR', 'IOInterfaceMapping', '[0:15]');

% Set Outport HDL parameters
hdlset_param('combinedTxRx_ExternalMode/Combined TX and RX/FromIPI', 'IOInterface', 'Rx data Q1 Out [0:15]');
hdlset_param('combinedTxRx_ExternalMode/Combined TX and RX/FromIPI', 'IOInterfaceMapping', '[0:15]');

% Set Outport HDL parameters
hdlset_param('combinedTxRx_ExternalMode/Combined TX and RX/FromIPvalid', 'IOInterface', 'Rx data Valid Out');
hdlset_param('combinedTxRx_ExternalMode/Combined TX and RX/FromIPvalid', 'IOInterfaceMapping', '[0]');

% Set Outport HDL parameters
hdlset_param('combinedTxRx_ExternalMode/Combined TX and RX/PacketsRX', 'IOInterface', 'AXI4-Lite');
hdlset_param('combinedTxRx_ExternalMode/Combined TX and RX/PacketsRX', 'IOInterfaceMapping', 'x"10C"');
