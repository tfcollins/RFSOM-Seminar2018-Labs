...
#define  IPCore_Timestamp_CombinedT_ip   0x8  //contains unique IP timestamp (yymmddHHMM): 1802011320
...
#define  PacketsRX_Data_CombinedT_ip     0x10C  //data register for Outport PacketsRX
