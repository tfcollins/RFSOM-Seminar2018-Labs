-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\combinedTxRx_ExternalMode\CombinedT_ip_src_SimpleDualPortRAM_generic.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: CombinedT_ip_src_SimpleDualPortRAM_generic
-- Source Path: combinedTxRx_ExternalMode/Combined TX and RX/Receiver HDL/Viterbi Decode/Buffer/HDL_FIFO2/SimpleDualPortRAM_generic
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY CombinedT_ip_src_SimpleDualPortRAM_generic IS
...
END CombinedT_ip_src_SimpleDualPortRAM_generic;


ARCHITECTURE rtl OF CombinedT_ip_src_SimpleDualPortRAM_generic IS
