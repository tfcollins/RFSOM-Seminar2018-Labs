-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\combinedTxRx_ExternalMode\CombinedT_ip_src_Combined_TX_and_RX.vhd
...
-- Source Path: combinedTxRx_ExternalMode/Combined TX and RX
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY CombinedT_ip_src_Combined_TX_and_RX IS
  PORT( clk                               :   IN    std_logic;
        ...
        ErrorSelect                       :   IN    std_logic_vector(7 DOWNTO 0);  -- int8
        ...
        PacketsRX                         :   OUT   std_logic_vector(31 DOWNTO 0)  -- uint32
        );
...
ARCHITECTURE rtl OF CombinedT_ip_src_Combined_TX_and_RX IS
  ...
  SIGNAL SelectorR                        : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL SelectorI                        : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL signal2                          : std_logic;
  SIGNAL IQ_Interface_Mapper_out4         : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL SelectorR_signed                 : signed(15 DOWNTO 0);  -- sfix16_En13
  SIGNAL delayMatch3_reg                  : vector_of_signed16(0 TO 19);  -- sfix16 [20]
  SIGNAL SelectorR_1                      : signed(15 DOWNTO 0);  -- sfix16_En13
  SIGNAL SelectorI_signed                 : signed(15 DOWNTO 0);  -- sfix16_En13
  SIGNAL delayMatch4_reg                  : vector_of_signed16(0 TO 19);  -- sfix16 [20]
  SIGNAL SelectorI_1                      : signed(15 DOWNTO 0);  -- sfix16_En13
...
BEGIN
  ...
  u_Receiver_HDL : CombinedT_ip_src_Receiver_HDL
    PORT MAP( clk => clk,
              ...
              FRLoopBW => LoopBW,  -- int16
              EQmu => EQmu,  -- int16
              Scope_Select => SelectScope,  -- int8
              DebugSelector => ErrorSelect,  -- int8
  ...
  u_IQ_Interface_Mapper : CombinedT_ip_src_IQ_Interface_Mapper
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              byteOut => Receiver_HDL_out1,  -- ufix64
              validOut => Receiver_HDL_out2,
              ...
              real_rsvd => SelectorR,  -- sfix16_En13
              imag => SelectorI,  -- sfix16_En13
              valid_1 => signal2,
              Out3 => IQ_Interface_Mapper_out4  -- uint32
              );
  ...
  SelectorR_signed <= signed(SelectorR);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        delayMatch3_reg(0) <= SelectorR_signed;
        delayMatch3_reg(1 TO 19) <= delayMatch3_reg(0 TO 18);
      END IF;
    END IF;
  END PROCESS delayMatch3_process;

  SelectorR_1 <= delayMatch3_reg(19);

  FromIPR <= std_logic_vector(SelectorR_1);

  SelectorI_signed <= signed(SelectorI);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        delayMatch4_reg(0) <= SelectorI_signed;
        delayMatch4_reg(1 TO 19) <= delayMatch4_reg(0 TO 18);
      END IF;
    END IF;
  END PROCESS delayMatch4_process;

  SelectorI_1 <= delayMatch4_reg(19);

  FromIPI <= std_logic_vector(SelectorI_1);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        delayMatch5_reg(0) <= signal2;
        delayMatch5_reg(1 TO 19) <= delayMatch5_reg(0 TO 18);
      END IF;
    END IF;
  END PROCESS delayMatch5_process;

  signal2_1 <= delayMatch5_reg(19);
  ...
  FromIPvalid <= signal2_1;

  PacketsRX <= IQ_Interface_Mapper_out4;
