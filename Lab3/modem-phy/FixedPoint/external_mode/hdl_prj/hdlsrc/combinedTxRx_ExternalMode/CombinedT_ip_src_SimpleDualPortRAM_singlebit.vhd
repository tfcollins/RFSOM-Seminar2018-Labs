-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\combinedTxRx_ExternalMode\CombinedT_ip_src_SimpleDualPortRAM_singlebit.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: CombinedT_ip_src_SimpleDualPortRAM_singlebit
-- Source Path: combinedTxRx_ExternalMode/Combined TX and RX/Receiver HDL/Viterbi Decode/Buffer/HDL_FIFO/SimpleDualPortRAM_singlebit
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY CombinedT_ip_src_SimpleDualPortRAM_singlebit IS
...
END CombinedT_ip_src_SimpleDualPortRAM_singlebit;


ARCHITECTURE rtl OF CombinedT_ip_src_SimpleDualPortRAM_singlebit IS
