-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\combinedTxRx_ExternalMode\CombinedT_ip_src_Real_Error.vhd
...
ENTITY CombinedT_ip_src_Real_Error IS
...
END CombinedT_ip_src_Real_Error;


ARCHITECTURE rtl OF CombinedT_ip_src_Real_Error IS

  -- Component Declarations
  COMPONENT CombinedT_ip_src_TED_Buffer_Update1_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : CombinedT_ip_src_TED_Buffer_Update1_block
    USE ENTITY work.CombinedT_ip_src_TED_Buffer_Update1_block(rtl);
  ...
  SIGNAL Product1_mul_temp                : signed(31 DOWNTO 0);  -- sfix32_En20
  SIGNAL Product1_out1                    : signed(15 DOWNTO 0);  -- sfix16_En12

BEGIN
  u_TED_Buffer_Update1 : CombinedT_ip_src_TED_Buffer_Update1_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  Product1_mul_temp <= TED_Buffer_Update1_out1_signed * Sub_out1;
