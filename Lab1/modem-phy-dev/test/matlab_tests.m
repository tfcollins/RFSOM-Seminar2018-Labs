classdef (TestTags = {'MATLAB','Float'})  matlab_tests < ReceiverModelTests
    ...
    %
    methods (Test, TestTags = {'Functional','Simulation','Float','Sizes','Failure'})
        function testPacketSizesSimulationFloatingPointSimFailure(testCase)
            transmitter = 'simulation';
            receiver = 'FloatingPointMATLAB';
            packetSizesBits = 64*[35,2,37,2,1/8];
            testCase.testPacketMultipleSizes(transmitter, receiver, packetSizesBits);
        end
    end
    %%
